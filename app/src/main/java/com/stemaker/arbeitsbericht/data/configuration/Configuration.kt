...
class ConfigurationStore {
    ...
    var activeHoursReportId: Long = 0
...
object Configuration {
    ...
    var activeReportId: String
        ...
        set(value) {
            store.activeReportId2 = value}

    var activeHoursReportId: Long
        get(): Long = store.activeHoursReportId
            set(value) {
                store.activeHoursReportId = value}
